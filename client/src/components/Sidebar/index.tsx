    ...
    <div className={sideBarClassnames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image src="https://pm-s3-photo.s3.us-east-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
          <div>
...
export const SidebarLink = ({
  ...
  return (
    <Link href={href} className="w-full">
      <div
        className={`dark:bg-blue relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 ${
